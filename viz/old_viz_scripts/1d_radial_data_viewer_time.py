...
for i in range(time_slices):
	...
	for n in range(num_procs):
		...
		infile = open("/users/asfierro/wheeler-scratch/2d_fluid_axisymmetric/data_temp/data_out_" + str(n) + "_" + str(c_time_slice) + ".dat","r");
	...
	for n in range(num_procs):
		if n == (num_procs-1):
			y_size = y_size + y_size_add
		infile = open("/users/asfierro/wheeler-scratch/2d_fluid_axisymmetric/source_term_data_temp/direct_source_term_out_" + str(n) + "_" + str(c_time_slice) + ".dat","r");
