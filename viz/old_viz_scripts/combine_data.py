...
outfile = open("/users/asfierro/wheeler-scratch/2d_fluid_axisymmetric/data/mesh_data/data_combined_" + str(file_select) + "_iteration_3.2da","wb");
for n in range(num_procs):
	infile = open("/users/asfierro/wheeler-scratch/2d_fluid_axisymmetric/data/mesh_data/data_out_" + str(n) + "_" + str(file_select) + "_iteration_3.dat","r");
	...
	for line in infile:
		if (cur_x % skip) == 0 and (cur_y % skip) == 0:
			...
			outfile.write(struct.pack('d',ed))
